...
contract SHKRAPPY is Context, IERC20, Ownable {
    ...
    string private _name = "Shkrappy Inu";
    string private _symbol = "SHKRAPPY";
    ...
    address public marketing = 0xa69F3c6174432044dae023334Dc63D4D58b99df3;
    ...
    uint256 public _maxBalAmount = _tTotal.mul(4).div(1000);
